...
describe('api/auth/profile', async () => {
  ...
  test('responds successfully with user details', (done) => {
    dbMock.mockImplementationOnce(() => new Promise((res) => res(userDetailsDbResult)));
  ...
  test('responds with 400 if invalid userId', (done) => {
...
describe('/user/:userId', async () => {
  const endpoint = '/api/user/1234';

  test('responds successfully with user details', (done) => {
    mysql.query = jest.fn(() => new Promise((res) => res(userDetailsDbResult)));
    getAuthRouteTest(done, endpoint, 200, userDetailsServerResponse);
  });
...
describe('api/user/:userId/tracks', async () => {
  const endpoint = '/api/user/1234/tracks';

  test('responds successfully with artist tracks', (done) => {
    mysql.query = jest.fn(() => new Promise((res) => res(artistTracksDbResult)));
    getAuthRouteTest(done, endpoint, 200, artistTracksServerResult);
  });

  test('fails when userid is invalid', (done) => {
  ...
  test('fails when db query fails', (done) => {
    mockDbError();
    getAuthRouteTest(done, endpoint, 500, genericErrorServerResponse);
  });
});

describe('api/auth/my-tracks', async () => {
  ...
  test('responds successfully with artist tracks', (done) => {
    dbMock.mockImplementationOnce(() => new Promise((res) => res(artistTracksDbResult)));
    getAuthRouteTest(done, endpoint, 200, artistTracksServerResult);
  });
...
describe('api/auth/liked-tracks', async () => {
  ...
  describe('GET', async () => {
    ...
    test('responds successfully with liked tracks', (done) => {
      mysql.query = jest.fn(() => new Promise((res) => res(likedTracksDbResult)));
  ...
  describe('POST', async () => {
    ...
    test('responds with tracks on success', (done) => {
      mockDbSuccess();
      postAuthRouteTest(done, endpoint, validPostData, 200, likeTrackSuccessServerResponse);
    });

    test('responds with 400 error with invalid inputs', (done) => {
      const errResponse = {
  ...
  describe('DELETE', async () => {
    ...
    test('responds with liked tracks', (done) => {
      mockDbSuccess();
      deleteAuthRouteTest(done, endpoint, {}, 200, unlikeTrackSuccessServerResponse);
    });

    test('responds with 400 error with invalid path param', (done) => {
...
describe('api/auth/my-links', async () => {
...
describe('/user/:userId/links', async () => {
  const endpoint = '/api/user/userId1/links';

  test('responds successfully with links', (done) => {
    mysql.query = jest.fn(() => new Promise((res) => res(userLinksDbResult)));
    getAuthRouteTest(done, endpoint, 200, userLinksServerResponse);
  });

  test('filters invalid links', (done) => {
    mysql.query = jest.fn(() => new Promise((res) => res(userInvalidLinksDbResult)));
    getAuthRouteTest(done, endpoint, 200, userLinksServerResponse);
  });
...
describe('/auth/user-link', async () => {
  ...
  describe('POST', () => {
    ...
    test('fails if invalid link value', (done) => {
      const invalidPostData = {
        url: 'https://open.spotify.com/artist/7t8q7ikEtcPNtoaKAm9Vu6',
        type: 'invalid-type',
      };
    ...
    test('fails if invalid path type', (done) => {
      const invalidPostData = {
